...
PKG_VERSION_PATH=github.com/PatchSimple/terraform-provider-pipeline/${PKG_NAME}
...
BUILD_PATH=terraform.d/plugins/registry.terraform.io/PatchSimple/pipeline/${NEXT_VERSION}/${TARGET_ARCH}
